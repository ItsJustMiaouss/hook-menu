...
local function DrawFrame()
	...
	frame:Center()
	frame:SetTitle("HookMenu - By ItsJustMiaouss")
	frame:MakePopup()
	...
	if next(serverHooksCache) == nil or next(clientHooksCache) == nil then
		net.Start("HookMenu:RefreshHooks")
		net.SendToServer()
	end
	CleanupData()
	PopulateData()
...
net.Receive("HookMenu:ServerHooksCallback", function()
...
net.Receive("HookMenu:OpenClientMenu", function() DrawFrame() end)
